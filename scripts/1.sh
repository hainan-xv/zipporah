...
cat $base/corpus/good.clean.short.$input_lang  | shuf --random-source=$base/corpus/good.clean.short.$input_lang > $base/corpus/good.shuffed.$input_lang
cat $base/corpus/good.clean.short.$output_lang | shuf --random-source=$base/corpus/good.clean.short.$input_lang > $base/corpus/good.shuffed.$output_lang

cat $base/corpus/good.shuffed.$input_lang  | head -n 1500000 >  $base/corpus/train.$input_lang
cat $base/corpus/good.shuffed.$output_lang | head -n 1500000 >  $base/corpus/train.$output_lang

cat $base/corpus/good.shuffed.$input_lang  | tail -n +1500000 >  $base/corpus/dev.$input_lang
cat $base/corpus/good.shuffed.$output_lang | tail -n +1500000 >  $base/corpus/dev.$output_lang
...
../zipporah/tools/generate-bow-scores $base/model/dict.$output_lang-$input_lang $base/corpus/dev.$output_lang $base/corpus/dev.$input_lang > $base/logs/xent.good.$output_lang-$input_lang &
../zipporah/tools/generate-bow-scores $base/model/dict.$input_lang-$output_lang $base/corpus/dev.$input_lang $base/corpus/dev.$output_lang > $base/logs/xent.good.$input_lang-$output_lang &

../zipporah/tools/generate-bow-scores $base/model/dict.$output_lang-$input_lang $base/corpus/dev.shuf.$output_lang $base/corpus/dev.$input_lang > $base/logs/xent.bad.$output_lang-$input_lang &
../zipporah/tools/generate-bow-scores $base/model/dict.$input_lang-$output_lang $base/corpus/dev.$input_lang $base/corpus/dev.$output_lang > $base/logs/xent.bad.$input_lang-$output_lang
...
#  cat $base/corpus/$data.shufboth.$input_lang >> $base/corpus/bad.$data.$input_lang
#  cat $base/corpus/$data.$output_lang >> $base/corpus/bad.$data.$output_lang
