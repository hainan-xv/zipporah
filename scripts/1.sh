...
echo $ROOT/tools/align-to-dict $dict_count_thresh $dict_total_count_thresh $base/corpus/good.clean.short.$input_lang $base/corpus/good.clean.short.$output_lang $alignmentdir/alignment $base/model/dict.$input_lang-$output_lang $base/model/dict.$output_lang-$input_lang
