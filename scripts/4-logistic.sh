...
echo python $ROOT/scripts/logistic.py $base/train.feats $base/train.label $base/model $testbase/feats.txt $testbase/scores.txt
python $ROOT/scripts/logistic.py $base/train.feats $base/train.label $base/model $testbase/feats.txt $testbase/scores.txt
)
